...
namespace CodeHub.iOS
{
    public static class UrlRouteProvider
    {
        private static Route[] Routes = {
            ...
            new Route("^[^/]*/(?<Username>[^/]*)/(?<Repository>[^/]*)/commits/(?<Node>[^/]*)/$", typeof(Core.ViewModels.Commits.CommitViewModel)),
        ...
        {
            //var viewDispatcher = Locator.Current.GetService<IMvxViewDispatcher>();
