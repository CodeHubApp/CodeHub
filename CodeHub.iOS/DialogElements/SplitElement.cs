...
namespace CodeHub.iOS.DialogElements
{
    public class SplitElement : Element, IElementSizing
    {
                ...
                if (_buttons != null)
                {
                    ...
                    for (var i = 0; i < _buttons.Length; i++)
                    {
                        ...
                        if (i != _buttons.Length - 1)
                            _seperatorViews[i].Frame = new CGRect(_buttons[i].Frame.Right, 0, 0.5f, Bounds.Height);
                    }
                }
            }
        ...
        public class SplitButton : UIButton
        {
            ...
            public SplitButton(UIImage image, string text, IReactiveCommand touched)
                : this(image, text, () => touched.ExecuteIfCan())
            {
