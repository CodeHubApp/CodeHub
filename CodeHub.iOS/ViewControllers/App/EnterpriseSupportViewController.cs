...
{
    public class EnterpriseSupportViewController : BaseViewController<EnterpriseSupportViewModel>
    {
        ...
        public override void ViewDidLoad()
        {
            ...
            webButton.TouchUpInside += (sender, e) => ViewModel?.GoToGitHubCommand.ExecuteIfCan();

            var button = new UIButton(UIButtonType.Custom);
            button.SetTitle("Email Me!", UIControlState.Normal);
            button.TouchUpInside += (sender, e) => ViewModel?.SubmitFeedbackCommand.ExecuteIfCan();
